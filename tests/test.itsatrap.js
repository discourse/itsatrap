...
describe('wrapping a specific element', function () {
  ...
  it('should work when constructing a new itsatrap object', function () {
    var spy = sinon.spy();

    var itsatrap = new ItsATrap(form);
    itsatrap.bind('a', spy);
  ...
  it('should allow you to create an empty itsatrap constructor', function () {
    var spy = sinon.spy();
